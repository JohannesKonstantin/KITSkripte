...
\subsection{Asymptotisch Verhalten von reellen Folgen ($\limsup$ und $\liminf$)}
...
\end{example}
\[ b_l := \sup_{n \geq \mathbb{N}} a_n \]
\[ c_l := \inf_{n \geq \mathbb{N}} a_n \]
...
\begin{enumerate}
  \item Also gilt
    ...
    \[\Longleftrightarrow \liminf_{n \to \infty} (a_n)>\limsup_{n \to \infty} (a_n)\]
