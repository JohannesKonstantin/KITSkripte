...
\begin{proof}
$\mathbb{Q} = \{ \frac{m}{n}: m \in \mathbb{Z}, n \in \mathbb{N}\}$ \qq C $\{(m,n), m \in \mathbb{Z}, n \in \mathbb{N}\}$
\end{proof}
\paragraph{Bemerkung} Es gibt eine explizite Abbildung von $\mathbb{Q}$ mittels eines Baumes. Literatur: Neil Calkin, Herbert Will: Recounting the Rationals
...
Sei $(a_n)_n$, $(b_n)_n$ konvergente Folgen

mit $\lim a_n  = \lim b_n = a$ 

und $(c_n)_n*a_n \leq c_n \leq b_n$ für fast alle $n$

$\implies (c_n)_n$ konvergiert und $\lim c_n=a$
